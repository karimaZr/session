...
public class login extends HttpServlet {
     ...
     */
     protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        if(email.equalsIgnoreCase(clt.getEmail())&&(clt.getPassword().equalsIgnoreCase(Util.MD5(password)))){
      ...
      /*  if(clt==null){
            ...
            response.sendRedirect("login.jsp?msg=Email ou mot de passe incorrect");
            }
        }*/
